...
from lab2sem2.game import Game
...
class Wavegenerator:
    """class Wavegenerator, state pattern"""
    def __init__(self, game: TowerDefenseGame):
        ...
        self.ticks = 1
        self.maxTicks = 2
        self.waveFile = open("patternspr/texts/waveTexts/WaveGenerator2.txt", "r")
...
class Infoboard:
    ...
    def __init__(self, game):
        ...
        self.image = ImageTk.PhotoImage(Image.open("patternspr/images/infoBoard.png"))
...
class Mouse:
    ...
    def __init__(self, game: TowerDefenseGame):
        ...
        self.image = Image.open("patternspr/images/mouseImages/HoveringCanPress.png")
        self.image = ImageTk.PhotoImage(self.image)
        self.canNotPressImage = Image.open("patternspr/images/mouseImages/HoveringCanNotPress.png")
        self.canNotPressImage = ImageTk.PhotoImage(self.canNotPressImage)

    def clicked(self, event):
        """clicked"""
        self.pressed = True  # sets a variable
        self.image = Image.open("patternspr/images/mouseImages/Pressed.png")
        self.image = ImageTk.PhotoImage(self.image)
...
class TrackingBullet(Projectile):
    ...
    def __init__(self, x, y, damage, speed, target):
        ...
        self.target = target
        self.image = Image.open("patternspr/images/projectileImages/bullet.png")
        self.image = ImageTk.PhotoImage(self.image)
...
class PowerShot(TrackingBullet):
    ...
    def __init__(self, x, y, damage, speed, target, slow):
        ...
        self.slow = slow
        self.image = Image.open("patternspr/images/projectileImages/powerShot.png")
        self.image = ImageTk.PhotoImage(self.image)
...
class AngledProjectile(Projectile):
    ...
    def __init__(self, x, y, damage, speed, angle, givenRange):
        ...
        self.image = Image.open("patternspr/images/projectileImages/arrow.png")
